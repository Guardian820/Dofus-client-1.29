    ...
    _loc1.href = function (oEvent)
    {
        ...
        switch (_loc3[0])
        {
            ...
            case "ShowPlayerPopupMenu":
            {
                ...
                {
                    this.addToQueue({object: this.api.kernel.GameManager, method: this.api.kernel.GameManager.showPlayerPopupMenu, params: [undefined, _loc3[1], null, null, null, _loc3[2], true]});
                }
                else
                {
