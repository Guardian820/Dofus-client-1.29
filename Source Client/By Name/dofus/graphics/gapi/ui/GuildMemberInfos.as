...
if (!dofus.graphics.gapi.ui.GuildMemberInfos)
{
    ...
    _loc1.updateData = function ()
    {
        ...
        this._btnPercentXP._visible = _loc2.canManageXPContitribution;
        ...
        this._btnRDefendTax.selected = _loc3.canDefendTaxCollector;
        ...
        this._btnRDefendTax.enabled = _loc4;
        ...
        this._btnModify.enabled = _loc2.isBoss || (_loc2.canManageRights || (_loc2.canManageRanks || _loc2.canManageXPContitribution));
    ...
    _loc1.click = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            case "_btnRDefendTax":
            {
                if (this._btnRDefendTax.selected)
                {
